...
describe('API Productos', () => {
    ...
    it('Obtener productos', async () => {
        const producto1 = new Producto({producto: 'Producto 1', 
            categoria: 'Categoría 1', existencia: 10, precio: 50});
        const producto2 = new Producto({ producto: 'Producto 2',
            categoria: 'Categoría 2', existencia: 5, precio: 25});
    ...
    it('Obtener productos por id', async () => {
        const producto = new Producto({ producto: 'Producto 1', 
            categoria: 'Categoría 1', existencia: 10, precio: 50});
        await producto.save();
